...
Route::get('/', [LoginController::class, 'doAdminLogin']);
...
Route::group(['prefix' => 'admin','middleware' => 'admin'], function () {
    ...
    Route::group(['prefix' => 'items'], function () {
        ...
        Route::get('/view/{id}', [AdminItemController::class, 'viewItem']);
        Route::post('/product/{id}', [AdminItemController::class, 'saveProduct']);
        Route::get('/product/update/{id}', [AdminItemController::class, 'updateProduct']);
        Route::put('/product/update/{id}', [AdminItemController::class, 'updateProduct']);
        Route::get('/product/get/{id}', [AdminItemController::class, 'getProduct']);
...
Route::get('get-subdomain', [CpanelController::class, 'getSubdomains']);
