...
@section('content')
        ...
        <section class="content">
            <div class="card card-outline shadow-3">
                <div class="card-header admin-cart-header">
                    <h3 class="card-title">Pending Call</h3>
                </div>
                <div class="card-body pb-0 shadow-3">
                    <table class="table  data-table">
                        ...
                        <tbody>
                        @if (count($pendingCall) > 0)
                            @foreach ($pendingCall as $key=> $value)
                        <tr>
                            <td>{{$key+1}}</td>
                            <td>{{$value->name}}</td>
                            ...
                            <td><button class="btn btn-sm admin-submit-btn-grad text-white" onclick="load_garment({{$value->id}})"><i class="fas fa-phone-alt"></i></button></td>
            ...
            <div class="card card-outline shadow-3">
                <div class="card-header admin-cart-header">
                    <h3 class="card-title">Processed Call</h3>
                </div>
                <div class="card-body pb-0 shadow-3">
                    <table class="table" id="process_call_datya">
                        <thead>
                            <tr>
                                <th>SL</th>
                                <th>Garment Name</th>
    ...
    <script src="{{asset('assets/callcenter/process_call.js')}}"></script>
    <script type="text/javascript">
        ...
        function save_call_details(){
            ...
            var google_form_query = $("#google_form_query").val();
            var whatsapp_no = $("#whatsapp_no").val();

            
            

            if ( (tc_code == '' || tc_code == null) || (call_status == '' || call_status == null) || (call_summary == '' || call_summary == null) ) {
                if (tc_code == '' || tc_code == null) {
            ...
            } else if ((call_status == 'Call Back') && (reschedule_date == '' || reschedule_date == null || reschedule_time == '' || reschedule_time == null)) {
                ...
                //console.log('test')
            } else if ((call_status == 'Interested') && (google_form_query == '' || google_form_query == null)) {
                if (google_form_query  == '' || google_form_query == null) {
                    alert("Google form query is required");
                    $("#google_form_query").focus();
                    return false;
                }
            } else {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        google_form_query:google_form_query,
