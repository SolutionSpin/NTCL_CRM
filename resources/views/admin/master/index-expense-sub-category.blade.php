                        ...
                        <div class="col-12 mb-3">
                            <div class="card card-outline shadow-3">
                                <div class="card-header admin-cart-header">
                                    <h3 class="card-title">Expense Sub Categories</h3>
                                    <button type="button" class="btn admin-submit-btn-grad float-right" data-toggle="modal"
                                            data-target="#ExpenseCategoryModel"><i class="fa fa-plus"></i>Add Expense Subcategory</button>
                                </div>
                                <div class="card-body">
                                    <div class="row">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Expense Subcategory</h5>
...
@push('js')
    <script>
        $(function() {
            ...
            $(document).on("click", ".add_expense_category", function(event) {
                ...
                $.ajax({
                    url: "{{ url('admin/masters/expense-sub-category/') }}",
    ...
    <script>
        ...
        $('body').on('click', '.editExpenseCategory', function() {
            'use strict';
            var id = $(this).data('id');
            var url = "{{ url('admin/masters/expense-sub-category/update') }}" + '/' + id;
    ...
    <script>
        ...
        $(document).on("click", ".edit_expense_category", function(event) {
            ...
            $.ajax({
                url: "{{ url('admin/masters/expense-sub-category/update') }}" + '/' + id,
