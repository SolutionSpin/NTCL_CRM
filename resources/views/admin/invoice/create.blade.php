                                    ...
                                    <div class="row">
                                        <div class="col-sm-4 col-md-3">
                                            <div class="form-group">
                                                <label class="form-label">Invoice Title/Product Name</label>
                                        ...
                                        <div class="table-responsive mt-4">
                                            <table class="table table-bordered border text-nowrap mb-0" id="invoice-table">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="tx-right">Discount Type</th>
                                                    <th class="tx-right">Discount Amount</th>
                                            ...
                                            <table class="table table-bordered border text-nowrap mb-0">
                                                        ...
                                                        <div class="invoice-notes row">
                                                            ...
                                                            <div class="col-sm-6 col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input value="0" class="form-control" type="text" name="discount_amount" id="discount_amount">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tx-right font-weight-semibold">{{ $currency }}<b
                                                            class="date discount_amount"> 0</b>
                                                    </td>
                                                </tr>
                                                <tr>
                        ...
                        <div class="form-group col-md-12 row">
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Discount type</label>
                                    <select class="form-control"
                                            name="discount_type_single" id="discount_type_single">
                                        <option value="Percent">Percent
                                        </option>
                                        <option value="Fixed">Fixed
                                        </option>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Discount Amount</label>
                                    <input value="0" class="form-control" type="text" name="discount_amount_single" id="discount_amount_single">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".add_item").on('click', function() {
                ...
                var qty = $("#qty").val();
                var price = $("#price").val();
                var discount_type_single = $("#discount_type_single").val()
                var discount_amount_single = parseFloat($("#discount_amount_single").val())
                if (isNaN(qty)) {
                ...
                var markup = '<tr id="row' + i + '" class="no"> <td class="text-left"> <h6>' + name +
                    ...
                    '" readonly/></td>' +
                    '<td><span class="discount_type_single">'+discount_type_single+'</span><input value="'+discount_type_single+'"  class="form-control" type="hidden" name="discount_type_single[]"></td>' +
                    '<td><span class="discount_amount_single">'+discount_amount_single+'</span><input value="'+discount_amount_single+'"  class="form-control" type="hidden" name="discount_amount_single[]"></td>' +
                    ' <td class="unit"><a href="#" class="btn btn-sm btn-dark radius-10  btn_edit" data-update_id="' +
                    i +
                ...
                if(discount_type_single=='Percent'){
                    discount_amount_single = discount_amount_single*total/100
                }
                if(discount_type_single=='Fixed'){
                    discount_amount_single = discount_amount_single
                }
                payable = payable + (total- parseFloat(discount_amount_single));
